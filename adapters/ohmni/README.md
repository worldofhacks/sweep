...
Paired encoder pose timing is optional and requires clock qualification for the active boot. See [pose timing](../../docs/ohmni-pose-timing.md) for the configuration and the conditions that leave capture timestamps unknown.
