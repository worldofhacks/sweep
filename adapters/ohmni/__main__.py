...
def main() -> int:
    ...
    try:
        ...
        try:
            ...
            # Node.run owns normal shutdown; construction or screen-bind failure
            # happens before its finally block can stop the already-started device.
            if not node_started:
                device.close()
    return 0
