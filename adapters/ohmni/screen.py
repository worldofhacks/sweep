                    ...
                    json.dumps(
                        {
                            ...
                            "operator_message": getattr(
                                getattr(device, "peripherals", None), "screen_message", ""
                            ),
                            ...
                            "home_pose_confirmed": node.config.home_pose_confirmed,
        ...
        def do_POST(self) -> None:
            ...
            if self.path == "/stop":
                ...
                if not device.spotter_present:
                    ...
                    return
                if not node.config.home_pose_confirmed:
                    self.reply(409, b'{"error":"home_pose_unconfirmed"}')
                    return
