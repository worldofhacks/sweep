...
object AircraftVariant {
    /** Always identifies synthetic telemetry; a hardware relay refuses it before admission. */
    val capabilities: List<String> = listOf("test:synthetic", "flight", "body_pulse_v1", "pano_360", "reconstruct_8")
