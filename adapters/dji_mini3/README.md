...
Export admission is bounded before a ZIP is written: at most 64 JSONL members, 64 MiB per
member, 128 MiB total source data, and a 1 MiB probe report. The app retains at most four
completed exports and refuses a fifth without deleting evidence; share and remove an older ZIP
before exporting again. Non-JSONL files under the evidence directories are never swept into an
