import { GroundSurveyPane } from './GroundSurveyPane'
...
export function GroundPane({ controller, now, services }: Pick<ModuleProps, 'controller'> & Partial<Pick<ModuleProps, 'now' | 'services'>>) {
  ...
  return <section className="ct-ground" aria-label="Ground controls">
    <h3>Ground robot</h3>
    ...
    <GroundSurveyPane controller={controller} now={now} services={services} />
  </section>
}
