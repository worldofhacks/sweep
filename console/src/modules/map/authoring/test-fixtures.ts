...
export function draftFixture(): MapDraft {
  return {
    ...
    metadata: { mapVersion: 'test-map-v1', floorId: 'test-floor', frame: 'world', resolutionM: 0.1, originXM: 0, originYM: 0,
      units: 'm', createdAt: 1000, creationEvidence: 'Isolated fixture creation record',
      registration: { sourceFrame: 'test-map', transformId: 'test-registration', residualM: 0.01, thresholdM: 0.02, evidence: 'Isolated fixture measurement record' } },
...
export function tagFixture(): MapTag {
  return { id: 'tag-record', tagId: 7, family: 'tag36h11', sizeM: 0.2, position: { x: 2, y: 2 }, heightM: 0, yawRad: 0, source: 'surveyed', confidence: 0.9, observations: ['test-observation'], usedForFlight: true, tapeVerified: true, tapeEvidence: 'Test-only tape measurement record' }
}
