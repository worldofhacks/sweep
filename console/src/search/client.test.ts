...
export function searchPreview(): SearchPreview { return { session: intent.session, intent_id: intent.intent_id, t: 100, expiresAt: 15_100, preview: { zone_id: 'lobby', target_class: 'backpack', allocations: [{ drone_id: 1, source_id: 'camera-1', task_id: 'task-1', workload_cells: 2, lane_count: 1 }] } } }
