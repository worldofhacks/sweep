...
export const NAVIGATION_CONFIRMATION_UNAVAILABLE = 'Navigation confirmation unavailable: the backend frozen-confirmation and dispatch contract is not implemented.'
