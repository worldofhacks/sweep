...
- Scheduling: hardware safety work takes priority until M2.0 passes. Interaction and Platform flight support is booked in bounded blocks. Language work, the third and fourth physical nodes, and the 4-to-6-drone simulator expansion start after M2.0.
