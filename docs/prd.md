...
- Outdoor field gate: the M2.7 fake-bridge configuration passes before the same stack flies the bounded field on three accepted Mini 3 nodes. Five consecutive runs meet the outdoor separation and route-safety metrics in section 2.
