...
The later [Atlas / hardware integration record](integration-atlas-hardware-2026-09-08.md)
documents the composition of this checkpoint into PR #338 and supersedes the
standalone branch/overlap status below for that combined head.
