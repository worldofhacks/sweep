...
Replay results use `unverified_replay` provenance because an editable cassette cannot independently prove its provider origin. Provider acceptance and corpus recordings remain release evidence that must be captured from the live API.
