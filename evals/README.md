...
The approved 2026-09-04 corpus revision expects `land-now` to return `unsupported` with `capability_unavailable`, matching the current selected-aircraft LAND capability contract. Its SHA-256 is `462c11c063ea1e73f337a6b2ce65772d5ff35e51b8af96b0878a6aec9b500800`. The synthetic replay passes all 50 cases through the production compiler. Reviewed live-provider evidence remains outstanding; synthetic responses and mocked recording tests cover the deterministic path.
