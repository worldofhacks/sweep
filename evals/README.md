...
`evidence/sonnet5-schema-acceptance.json` records the bounded live request that verified Anthropic accepted the transformed strict tool schema. Replay results use `unverified_replay` provenance because an editable cassette cannot independently prove its provider origin.
