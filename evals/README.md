...
Selected-aircraft `land` preserves the current selection through the compiler, relay, planner, and adapter. The synthetic replay passes all 50 cases through the production compiler. Reviewed live-provider evidence remains outstanding; synthetic responses and mocked recording tests cover the deterministic path.
