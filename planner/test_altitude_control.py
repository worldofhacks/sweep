...
def test_absolute_height_above_explicit_floor_converges_different_starting_heights():
...
def test_signed_building_height_uses_surveyed_floor(monkeypatch):
